...
__all__ = [
    # Audio Settings
    'QUANTUM_VALUES', 'SAMPLE_RATE_VALUES', 'QUANTUM', 'SAMPLE_RATE',
    'VIRTUAL_SINK_MODULE_IDS', 'UNIFIED_VIRTUAL_SINKS',
    'VIRTUAL_SINKS_RECREATE_AT_AUTOSTART',
    # App Settings
    'TRAY_ENABLED', 'TRAY_CLICK_OPENS_CABLES',
    'REMEMBER_SETTINGS', 'RESTORE_ONLY_MINIMIZED', 'SAVED_QUANTUM',
    'SAVED_SAMPLE_RATE', 'AUTOSTART_ENABLED', 'CHECK_UPDATES_AT_START',
    'APPIMAGE_PATH', 'INTEGRATE_CABLE_AND_CABLES', 'VERBOSE_OUTPUT',
    # UI Settings
    'AUTO_REFRESH_ENABLED', 'COLLAPSE_ALL_ENABLED',
    'PORT_LIST_FONT_SIZE', 'MAX_FONT_SIZE', 'MIN_FONT_SIZE',
    'UNTANGLE_MODE', 'LAST_ACTIVE_TAB',
    'LOAD_PRESET_STRICT_MODE', 'LOAD_PRESET_DAEMON_MODE',
    'LOAD_PRESET_RESTORE_LAYOUT',
    'MIDI_SPLITTER_SIZES', 'MIDI_MATRIX_SPLITTER_SIZES',
    'MIDI_MATRIX_V_SPLITTER_SIZES', 'MIDI_MATRIX_ZOOM_LEVEL',
    'ENABLE_MIDI_MATRIX',
    # Window Geometry
    'MAIN_WINDOW_GEOMETRY', 'CONN_MANAGER_GEOMETRY',
    'EMBEDDED_COLUMN_WIDTH', 'EMBEDDED_SETTINGS_VISIBLE',
    # Graph Settings
    'GRAPH_SPLIT_AUDIO_MIDI_CLIENTS', 'GRAPH_UNTANGLE_VALUES',
    'GRAPH_AUTO_LAYOUT_SPLIT', 'GRAPH_COLORED_CONNECTIONS',
    'GRAPH_WALLPAPER_PATH', 'GRAPH_WALLPAPER_SCALING',
    'GRAPH_WALLPAPER_LAST_DIR',
    # Connection Settings
    'USE_STRAIGHT_LINES', 'CONNECTION_LINE_THICKNESS',
    'CONNECTION_VIEW_INITIAL_WIDTH', 'PWTOP_FONT_SIZE_PT',
    # Preset Settings
    'STARTUP_PRESET', 'ACTIVE_PRESET',
    # Confirmation Dialogs
    'SHOW_HIDE_NODE_CONFIRMATION', 'SHOW_UNLOAD_ALL_SINKS_CONFIRMATION',
    'DEFAULT_PRESET_SKIP_CONFIRMATION',
    # Migration Status
    'MIGRATION_DIALOG_SHOWN',
    # Mixer Settings
    'ALSA_MIXER_ZOOM_LEVEL', 'LAST_ALSA_MIXER_CARD_INDEX',
    # Tab Types
    'TAB_AUDIO', 'TAB_MIDI', 'TAB_MIDI_MATRIX', 'TAB_GRAPH',
    'TAB_PWTOP', 'TAB_ALSA_MIXER', 'TAB_LATENCY', 'TAB_CABLE',
    'TAB_UNKNOWN', 'TAB_DISPLAY_MAP',
]
...
GRAPH_WALLPAPER_SCALING = '_graph_wallpaper_scaling'
