...
class NodeVisibilityDialog(QDialog):
    ...
    def _populate_nodes(self) -> None:
        ...
        if self.tab_type in [keys.TAB_AUDIO, keys.TAB_GRAPH]:
    ...
    def _on_node_checkbox_changed(self, state: int, input_checkbox: Optional['QCheckBox'], output_checkbox: Optional['QCheckBox']) -> None:
    ...
    def _update_node_checkbox_state(self, node_checkbox: 'QCheckBox', input_checkbox: Optional['QCheckBox'], output_checkbox: Optional['QCheckBox']) -> None:
    ...
    def _get_unique_client_names(self, is_midi: bool = False) -> set:
        ...
        try:
            ...
            if self.connection_manager.config_manager is not None:
                split_audio_midi = self.connection_manager.config_manager.get_bool(keys.GRAPH_SPLIT_AUDIO_MIDI_CLIENTS, False)
