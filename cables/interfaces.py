...
if TYPE_CHECKING:
    from PyQt6.QtWidgets import QTreeWidget, QWidget, QPushButton, QTextEdit, QComboBox, QCheckBox
...
class PortTreeProvider(Protocol):
    ...
    def _restore_selection(self, tree_widget: 'QTreeWidget', selection_info: tuple) -> None:
...
@runtime_checkable
class MidiMatrixInterface(
    ConfigProvider,
    ConnectionOperations,
    Protocol
):
    """
    Complete interface needed by MidiMatrixWidget.
    
    This combines all the capabilities that MidiMatrixWidget needs from
    JackConnectionManager.
    """
    pass
